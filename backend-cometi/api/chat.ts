...
import { processChatRequest, type ChatPayload } from '../src/chat-service';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const payload = (typeof req.body === 'string' ? JSON.parse(req.body) : req.body) as ChatPayload | undefined;
